...
export const generationJobSchema = z.object({
  ...
  validationMode: z.enum(['full', 'content-only']).default('full'),
  qualityGateEnabled: z.boolean().default(true),
  inputHash: z.string(),
...
export const artifactManifestSchema = z.object({
  ...
  artifactNamingVersion: z.number().int().min(0).default(0),
  unitId: z.string(),
  ...
  targetStatus: z.enum(['published', 'offline', 'degraded']).optional(),
